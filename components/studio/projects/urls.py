...
urlpatterns = [
    ...
    path('<user>/<project_slug>/createflavor', views.create_flavor, name='create_flavor'),
    path('<user>/<project_slug>/deleteflavor', views.delete_flavor, name='delete_flavor'),
    path('<user>/<project_slug>/createenvironment', views.create_environment, name='create_environment'),
    path('<user>/<project_slug>/deleteenvironment', views.delete_environment, name='delete_environment'),
    path('<user>/<project_slug>/details/change', views.change_description, name='change_description'),
    path('<user>/<project_slug>/image/update', views.update_image, name='update_image'),
