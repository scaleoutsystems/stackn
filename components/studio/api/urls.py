...
router.register(r'projecttemplates', ProjectTemplateList,
                basename='projecttemplates')
...
models_router.register(r'appinstances', AppInstanceList,
                       basename='appinstances')
models_router.register(r'flavors', FlavorsList, basename='flavors')
models_router.register(r'environments', EnvironmentList,
                       basename='environment')
models_router.register(r's3', S3List, basename='s3')
models_router.register(r'mlflow', MLflowList, basename='mlflow')
models_router.register(r'releasenames', ReleaseNameList,
                       basename='releasenames')
