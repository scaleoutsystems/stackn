...
class ModelViewTests(TestCase):
    ...
    def test_access_models_list(self):
        """
        ...
        self.assertContains(response, "<title>Models | SciLifeLab Serve</title>")
...
class ModelViewForbidden(TestCase):
    ...
    def test_forbidden_models_list(self):
        ...
        self.assertTemplateUsed(response, "403.html")
        self.assertEqual(response.status_code, 403)
        self.assertContains(response, "<title>Forbidden | SciLifeLab Serve</title>")
