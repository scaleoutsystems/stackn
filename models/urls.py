...
urlpatterns = [
    ...
    path(
        ...
        views.unpublish_model,
        name="unpublish_model",
    ),
    path(
        "<user>/<project>/models/<int:id>/access",
        views.change_access,
        name="change_access",
    ),
    path(
        "<user>/<project>/models/<int:id>/upload",
        views.upload_model_headline,
        name="upload_model_headline",
    ),
    path(
        "<user>/<project>/models/<int:id>/docker",
        views.add_docker_image,
