    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release_type', models.CharField(choices=[('M', 'Major'), ('m', 'Minor')], default='m', max_length=255)),
                ...
                ('docker_image', models.OneToOneField(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='projects.environment')),
                ...
                ('s3', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='projects.s3')),
                ('tags', tagulous.models.fields.TagField(_set_tag_meta=True, blank=True, help_text='Enter a comma-separated tag string', to='models.Tagulous_Model_tags')),
            ],
            options={
